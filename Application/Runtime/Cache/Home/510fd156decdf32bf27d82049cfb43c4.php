        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-4">
              <div id="logo">
                <a href="">
                  <img src="/GitRepository/GitHub/BuyPlus/Public/Home/image/logo3.png" title="XMall商城" alt="XMall商城" class="img-responsive" />
                </a>
              </div>
            </div>
          ...
          <h1>用户注册</h1>
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab-email-register">
                <form action="<?php echo U('/register');?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <fieldset id="account">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="name" value="" placeholder="您的姓名" id="input-name" class="form-control" />
                      </div>
                    </div>

                    <div class="form-group hidden">
                      <label class="col-sm-2 control-label" for="input-fax">&nbsp;&nbsp;传真号码</label>
                      <div class="col-sm-10">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <label class="radio-inline">
                          <input type="radio" name="is_newsletter" value="1" />
                          是
                        </label>
                        <label class="radio-inline">
                          <input type="radio" name="is_newsletter" value="0" checked="checked" />
                          否
                        </label>
                      </div>
                    </div>
              ...
              <div class="tab-pane " id="tab-telephone-register">
                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <fieldset id="tel-account">
                    ...
                    <div class="form-group">
                      <label class="col-sm-2 control-label" for="input-tel-name">您的姓名</label>
                      <div class="col-sm-10">
                        <input type="text" name="name" value="" placeholder="您的姓名" id="input-tel-name" class="form-control" />
                      </div>
                    </div>
            ...
            <div class="col-sm-4">
              ...
              <ul class="list-unstyled">
                ...
                <li>
                  ...
                  <div class="text">yaoxue2014@hotmail.com</div>
                </li>
              </ul>
            </div>
          </div>
