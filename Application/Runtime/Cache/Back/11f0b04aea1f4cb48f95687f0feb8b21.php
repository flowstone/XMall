...
<head>
  ...
  <link href="/ITBull/BuyPlus/Public/Back/bootstrap/css/bootstrap.css" type="text/css" rel="stylesheet" />
  <link href="/ITBull/BuyPlus/Public/Back/font-awesome/css/font-awesome.min.css" type="text/css" rel="stylesheet" />
  <link href="/ITBull/BuyPlus/Public/Back/summernote/summernote.css" rel="stylesheet" />
  <link href="/ITBull/BuyPlus/Public/Back/datetimepicker/bootstrap-datetimepicker.min.css" type="text/css" rel="stylesheet" media="screen" />
  <link type="text/css" href="/ITBull/BuyPlus/Public/Back/stylesheet/stylesheet.css" rel="stylesheet" media="screen" />
  ...
  <div id="container">
    <header id="header" class="navbar navbar-static-top">
      <div class="navbar-header">
        ...
        <a href="" class="navbar-brand">
          <img src="/ITBull/BuyPlus/Public/Back/image/logo.png" alt="OpenCart" title="OpenCart" />
        </a>
      </div>
    ...
    <nav id="column-left">
      <div id="profile">
        ...
        -->
        <img src="/ITBull/BuyPlus/Public/Back/image/avatar.png" style="max-width:42px; max-height: 42px;" ></div>
      <div>
        <h4>HelloKang</h4>
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-hover">
                ...
                <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td class="text-center">
                      <img src="/ITBull/BuyPlus/Public/Back/image/avatar.png" alt="HEAD" class="img-thumbnail" style="max-width: 40px"/>
                    </td>
...
<footer id="footer">
  ...
  <script type="text/javascript" src="/ITBull/BuyPlus/Public/Back/jquery/jquery-2.1.1.min.js"></script>
  <script type="text/javascript" src="/ITBull/BuyPlus/Public/Back/bootstrap/js/bootstrap.min.js"></script>
  <script type="text/javascript" src="/ITBull/BuyPlus/Public/Back/summernote/summernote.js"></script>
  <script src="/ITBull/BuyPlus/Public/Back/datetimepicker/moment.js" type="text/javascript"></script>
  <script src="/ITBull/BuyPlus/Public/Back/datetimepicker/bootstrap-datetimepicker.min.js" type="text/javascript"></script>
  <script src="/ITBull/BuyPlus/Public/Back/javascript/common.js" type="text/javascript"></script>
</body>
</html>